...
<script type="text/html" data-template-name="model">
    ...
    <div class="form-row">
        ...
        <div style="display:inline-flex; align-items:center; gap:6px; width:70%;">
            ...
            <input type="text" id="node-input-script" readonly placeholder="No script selected" style="flex:1; min-width:0;">
        </div>
    </div>
            ...
            if (uploadLuaFile && uploadLuaFile.files.length > 0) {
                ...
                fetch(`http://${host}:${port}/api/deviceMgr/uploadLuaScript`, {
                    ...
                    .then((result) => {
                        ...
                        console.log("Lua script uploaded:", result);
                    })
                    .catch((err) => console.log("Lua upload error:", err));
            }
        },
    });
