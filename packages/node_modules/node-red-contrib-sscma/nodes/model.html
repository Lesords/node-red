...
<script type="text/javascript">
    ...
    RED.nodes.registerType("model", {
        ...
        oneditsave: function () {
            ...
            // Upload Lua script if a new file was selected and upload API is available
            const uploadLuaFile = document.getElementById("upload-lua-file");
                ...
                fetch(`http://${host}:${port}/api/deviceMgr/uploadLuaScript`, {
                    ...
                    .then((result) => {
                        if (result.code === 0 && result.data && result.data.path) {
                            node.script = result.data.path;
                            document.getElementById("node-input-script").value = result.data.path;
