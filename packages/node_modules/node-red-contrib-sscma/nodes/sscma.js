                        ...
                        if (node.users[id]) {
                            try {
                                ...
                                if (payload.name === "enabled") {
                                    ...
                                    node.users[id].status({ fill: "red", shape: "ring", text: typeof payload.data === 'string' ? payload.data : (payload.data && payload.data.message ? payload.data.message : JSON.stringify(payload.data)) });
                                }
